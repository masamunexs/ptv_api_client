...
class V3BulkDeparturesRouteDirectionResponse {
  ...
  static List<V3BulkDeparturesRouteDirectionResponse> listFromJson(List<dynamic> json) {
    return json == null ? List<V3BulkDeparturesRouteDirectionResponse>() : json.map((value) => V3BulkDeparturesRouteDirectionResponse.fromJson(value)).toList();
  }

  static Map<String, V3BulkDeparturesRouteDirectionResponse> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, V3BulkDeparturesRouteDirectionResponse>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = V3BulkDeparturesRouteDirectionResponse.fromJson(value));
    }
    return map;
  }
}
