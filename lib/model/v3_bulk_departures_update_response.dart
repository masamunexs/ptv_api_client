...
class V3BulkDeparturesUpdateResponse {
  ...
  V3BulkDeparturesUpdateResponse.fromJson(Map<String, dynamic> json) {
    ...
    if (json['requested_route_direction'] == null) {
      ...
      requestedRouteDirection = V3BulkDeparturesRouteDirectionResponse.fromJson(json['requested_route_direction']);
    }
    ...
    if (json['route_direction'] == null) {
      ...
      routeDirection = V3BulkDeparturesRouteDirectionResponse.fromJson(json['route_direction']);
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (routeDirection != null)
      json['route_direction'] = routeDirection;
    return json;
  }

  static List<V3BulkDeparturesUpdateResponse> listFromJson(List<dynamic> json) {
    return json == null ? List<V3BulkDeparturesUpdateResponse>() : json.map((value) => V3BulkDeparturesUpdateResponse.fromJson(value)).toList();
  }

  static Map<String, V3BulkDeparturesUpdateResponse> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, V3BulkDeparturesUpdateResponse>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = V3BulkDeparturesUpdateResponse.fromJson(value));
    }
    return map;
  }
}
