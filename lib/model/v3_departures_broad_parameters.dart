...
class V3DeparturesBroadParameters {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (platformNumbers != null) json['platform_numbers'] = platformNumbers;
  ...
  static List<V3DeparturesBroadParameters> listFromJson(List<dynamic> json) {
    return json == null
        ? List<V3DeparturesBroadParameters>()
        : json
            .map((value) => V3DeparturesBroadParameters.fromJson(value))
            .toList();
  }

  static Map<String, V3DeparturesBroadParameters> mapFromJson(
      Map<String, dynamic> json) {
    var map = Map<String, V3DeparturesBroadParameters>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) =>
          map[key] = V3DeparturesBroadParameters.fromJson(value));
    }
    return map;
  }
}
