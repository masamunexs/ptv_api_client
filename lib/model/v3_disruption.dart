...
class V3Disruption {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (disruptionId != null)
      json['disruption_id'] = disruptionId;
    if (title != null)
      json['title'] = title;
    if (url != null)
      json['url'] = url;
    ...
    if (disruptionStatus != null)
      json['disruption_status'] = disruptionStatus;
    if (disruptionType != null)
      json['disruption_type'] = disruptionType;
    if (publishedOn != null)
      json['published_on'] = publishedOn == null ? null : publishedOn.toUtc().toIso8601String();
    if (lastUpdated != null)
      json['last_updated'] = lastUpdated == null ? null : lastUpdated.toUtc().toIso8601String();
    if (fromDate != null)
      json['from_date'] = fromDate == null ? null : fromDate.toUtc().toIso8601String();
    if (toDate != null)
      json['to_date'] = toDate == null ? null : toDate.toUtc().toIso8601String();
    if (routes != null)
      json['routes'] = routes;
    if (stops != null)
      json['stops'] = stops;
    ...
    if (displayOnBoard != null)
      json['display_on_board'] = displayOnBoard;
    if (displayStatus != null)
      json['display_status'] = displayStatus;
    return json;
  }

  static List<V3Disruption> listFromJson(List<dynamic> json) {
    return json == null ? List<V3Disruption>() : json.map((value) => V3Disruption.fromJson(value)).toList();
  }

  static Map<String, V3Disruption> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, V3Disruption>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = V3Disruption.fromJson(value));
    }
    return map;
  }
}
