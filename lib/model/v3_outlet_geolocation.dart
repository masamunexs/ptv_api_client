...
class V3OutletGeolocation {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (outletDistance != null)
      json['outlet_distance'] = outletDistance;
  ...
  static List<V3OutletGeolocation> listFromJson(List<dynamic> json) {
    return json == null ? List<V3OutletGeolocation>() : json.map((value) => V3OutletGeolocation.fromJson(value)).toList();
  }

  static Map<String, V3OutletGeolocation> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, V3OutletGeolocation>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = V3OutletGeolocation.fromJson(value));
    }
    return map;
  }
}
