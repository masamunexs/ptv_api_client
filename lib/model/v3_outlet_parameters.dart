...
class V3OutletParameters {
  ...
  static List<V3OutletParameters> listFromJson(List<dynamic> json) {
    return json == null ? List<V3OutletParameters>() : json.map((value) => V3OutletParameters.fromJson(value)).toList();
  }

  static Map<String, V3OutletParameters> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, V3OutletParameters>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = V3OutletParameters.fromJson(value));
    }
    return map;
  }
}
