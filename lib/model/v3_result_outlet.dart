...
class V3ResultOutlet {
  ...
  static List<V3ResultOutlet> listFromJson(List<dynamic> json) {
    return json == null ? List<V3ResultOutlet>() : json.map((value) => V3ResultOutlet.fromJson(value)).toList();
  }

  static Map<String, V3ResultOutlet> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, V3ResultOutlet>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = V3ResultOutlet.fromJson(value));
    }
    return map;
  }
}
