...
class V3ResultRoute {
  ...
  static List<V3ResultRoute> listFromJson(List<dynamic> json) {
    return json == null ? List<V3ResultRoute>() : json.map((value) => V3ResultRoute.fromJson(value)).toList();
  }

  static Map<String, V3ResultRoute> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, V3ResultRoute>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = V3ResultRoute.fromJson(value));
    }
    return map;
  }
}
