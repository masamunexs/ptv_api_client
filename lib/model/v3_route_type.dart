...
class V3RouteType {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (routeTypeName != null)
      json['route_type_name'] = routeTypeName;
    if (routeType != null)
  ...
  static List<V3RouteType> listFromJson(List<dynamic> json) {
    return json == null ? List<V3RouteType>() : json.map((value) => V3RouteType.fromJson(value)).toList();
  }

  static Map<String, V3RouteType> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, V3RouteType>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = V3RouteType.fromJson(value));
    }
    return map;
  }
}
