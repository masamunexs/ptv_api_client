...
class V3RunResponse {
  ...
  static List<V3RunResponse> listFromJson(List<dynamic> json) {
    return json == null ? List<V3RunResponse>() : json.map((value) => V3RunResponse.fromJson(value)).toList();
  }

  static Map<String, V3RunResponse> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, V3RunResponse>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = V3RunResponse.fromJson(value));
    }
    return map;
  }
}
