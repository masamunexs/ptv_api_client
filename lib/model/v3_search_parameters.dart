...
class V3SearchParameters {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (includeAddresses != null)
      json['include_addresses'] = includeAddresses;
    if (includeOutlets != null)
      json['include_outlets'] = includeOutlets;
  ...
  static List<V3SearchParameters> listFromJson(List<dynamic> json) {
    return json == null ? List<V3SearchParameters>() : json.map((value) => V3SearchParameters.fromJson(value)).toList();
  }

  static Map<String, V3SearchParameters> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, V3SearchParameters>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = V3SearchParameters.fromJson(value));
    }
    return map;
  }
}
