...
class V3StopAccessibility {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (escalator != null)
      json['escalator'] = escalator;
    if (hearingLoop != null)
      json['hearing_loop'] = hearingLoop;
    if (lift != null)
      json['lift'] = lift;
    if (stairs != null)
      json['stairs'] = stairs;
    if (stopAccessible != null)
      json['stop_accessible'] = stopAccessible;
    if (tactileGroundSurfaceIndicator != null)
      json['tactile_ground_surface_indicator'] = tactileGroundSurfaceIndicator;
    if (waitingRoom != null)
      json['waiting_room'] = waitingRoom;
    if (wheelchair != null)
      json['wheelchair'] = wheelchair;
    return json;
  }

  static List<V3StopAccessibility> listFromJson(List<dynamic> json) {
    return json == null ? List<V3StopAccessibility>() : json.map((value) => V3StopAccessibility.fromJson(value)).toList();
  }

  static Map<String, V3StopAccessibility> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, V3StopAccessibility>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = V3StopAccessibility.fromJson(value));
    }
    return map;
  }
}
