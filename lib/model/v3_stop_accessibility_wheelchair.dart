...
class V3StopAccessibilityWheelchair {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (accessibleRamp != null)
      json['accessible_ramp'] = accessibleRamp;
    if (parking != null)
    ...
    if (lowTicketCounter != null)
      json['low_ticket_counter'] = lowTicketCounter;
    if (manouvering != null)
      json['manouvering'] = manouvering;
    if (raisedPlatform != null)
      json['raised_platform'] = raisedPlatform;
    if (ramp != null)
      json['ramp'] = ramp;
    if (secondaryPath != null)
      json['secondary_path'] = secondaryPath;
    if (raisedPlatformShelther != null)
      json['raised_platform_shelther'] = raisedPlatformShelther;
    if (steepRamp != null)
      json['steep_ramp'] = steepRamp;
    return json;
  }

  static List<V3StopAccessibilityWheelchair> listFromJson(List<dynamic> json) {
    return json == null ? List<V3StopAccessibilityWheelchair>() : json.map((value) => V3StopAccessibilityWheelchair.fromJson(value)).toList();
  }

  static Map<String, V3StopAccessibilityWheelchair> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, V3StopAccessibilityWheelchair>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = V3StopAccessibilityWheelchair.fromJson(value));
    }
    return map;
  }
}
