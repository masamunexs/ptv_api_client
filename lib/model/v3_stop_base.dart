...
class V3StopBase {
  ...
  static List<V3StopBase> listFromJson(List<dynamic> json) {
    return json == null ? List<V3StopBase>() : json.map((value) => V3StopBase.fromJson(value)).toList();
  }

  static Map<String, V3StopBase> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, V3StopBase>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = V3StopBase.fromJson(value));
    }
    return map;
  }
}
