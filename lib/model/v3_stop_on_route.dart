...
class V3StopOnRoute {
  ...
  static List<V3StopOnRoute> listFromJson(List<dynamic> json) {
    return json == null ? List<V3StopOnRoute>() : json.map((value) => V3StopOnRoute.fromJson(value)).toList();
  }

  static Map<String, V3StopOnRoute> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, V3StopOnRoute>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = V3StopOnRoute.fromJson(value));
    }
    return map;
  }
}
