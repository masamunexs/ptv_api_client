...
class V3StopStaffing {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (friAmFrom != null)
      json['fri_am_from'] = friAmFrom;
    if (friAmTo != null)
      json['fri_am_to'] = friAmTo;
    if (friPmFrom != null)
      json['fri_pm_from'] = friPmFrom;
    if (friPmTo != null)
      json['fri_pm_to'] = friPmTo;
    if (monAmFrom != null)
      json['mon_am_from'] = monAmFrom;
    if (monAmTo != null)
      json['mon_am_to'] = monAmTo;
    if (monPmFrom != null)
      json['mon_pm_from'] = monPmFrom;
    if (monPmTo != null)
      json['mon_pm_to'] = monPmTo;
    if (phAdditionalText != null)
      json['ph_additional_text'] = phAdditionalText;
    if (phFrom != null)
      json['ph_from'] = phFrom;
    if (phTo != null)
      json['ph_to'] = phTo;
    if (satAmFrom != null)
      json['sat_am_from'] = satAmFrom;
    if (satAmTo != null)
      json['sat_am_to'] = satAmTo;
    if (satPmFrom != null)
      json['sat_pm_from'] = satPmFrom;
    if (satPmTo != null)
      json['sat_pm_to'] = satPmTo;
    if (sunAmFrom != null)
      json['sun_am_from'] = sunAmFrom;
    if (sunAmTo != null)
      json['sun_am_to'] = sunAmTo;
    if (sunPmFrom != null)
      json['sun_pm_from'] = sunPmFrom;
    if (sunPmTo != null)
      json['sun_pm_to'] = sunPmTo;
    if (thuAmFrom != null)
      json['thu_am_from'] = thuAmFrom;
    if (thuAmTo != null)
      json['thu_am_to'] = thuAmTo;
    if (thuPmFrom != null)
      json['thu_pm_from'] = thuPmFrom;
    if (thuPmTo != null)
      json['thu_pm_to'] = thuPmTo;
    if (tueAmFrom != null)
      json['tue_am_from'] = tueAmFrom;
    if (tueAmTo != null)
      json['tue_am_to'] = tueAmTo;
    if (tuePmFrom != null)
      json['tue_pm_from'] = tuePmFrom;
    if (tuePmTo != null)
      json['tue_pm_to'] = tuePmTo;
    if (wedAmFrom != null)
      json['wed_am_from'] = wedAmFrom;
    if (wedAmTo != null)
      json['wed_am_to'] = wedAmTo;
    if (wedPmFrom != null)
      json['wed_pm_from'] = wedPmFrom;
    if (wedPmTo != null)
      json['wed_pm_To'] = wedPmTo;
    return json;
  }

  static List<V3StopStaffing> listFromJson(List<dynamic> json) {
    return json == null ? List<V3StopStaffing>() : json.map((value) => V3StopStaffing.fromJson(value)).toList();
  }

  static Map<String, V3StopStaffing> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, V3StopStaffing>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = V3StopStaffing.fromJson(value));
    }
    return map;
  }
}
