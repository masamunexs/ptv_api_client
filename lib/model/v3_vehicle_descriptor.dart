...
class V3VehicleDescriptor {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (id != null)
      json['id'] = id;
    if (lowFloor != null)
      json['low_floor'] = lowFloor;
    if (airConditioned != null)
      json['air_conditioned'] = airConditioned;
    if (description != null)
  ...
  static List<V3VehicleDescriptor> listFromJson(List<dynamic> json) {
    return json == null ? List<V3VehicleDescriptor>() : json.map((value) => V3VehicleDescriptor.fromJson(value)).toList();
  }

  static Map<String, V3VehicleDescriptor> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, V3VehicleDescriptor>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = V3VehicleDescriptor.fromJson(value));
    }
    return map;
  }
}
